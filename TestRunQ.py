...
for e in range(n_episodes+10):
    ...
    for i in range(max_iter_episode):
        ...
        Q_table[current_state[0], q_action_index] = (1 - lr) * Q_table[current_state[0], q_action_index] + lr * (
                    reward + gamma * max(Q_table[next_state[0], :]) - Q_table[current_state[0], q_action_index])
    ...
    total_rewards_episode.append(total_episode_reward/100)
    ...
    if e == 10000:
        ...
        plt.ylabel('Reward')
        plt.title("Q-Learning Mean Reward Per Episode (n=10000)")
        plt.xlabel("Episodes")
